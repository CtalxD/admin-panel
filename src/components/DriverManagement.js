    ...
    const filteredDrivers = drivers
        .filter((driver) => {
            const matchesSearch =
                ...
                (driver.document?.busNumber?.toString().toLowerCase().includes(searchTerm.toLowerCase()) || false);
            ...
            <div className="header-section">
                ...
                <div className="controls">
                    <div className="search-container">
                        ...
                        <input
                            type="text"
                            placeholder="Search by ID, name, email, license or bus number..."
                            value={searchTerm}
                            ...
                            {filteredDrivers.length > 0 ? (
                                filteredDrivers.map((driver) => (
                                    <tr key={driver.id}>
                                        ...
                                        <td>{driver.document?.busNumber || "N/A"}</td>
                                        <td>
                                            {driver.document ? (
                                                <>
